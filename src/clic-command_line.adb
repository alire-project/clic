--  This package is imported from GNAT FSF 11.2 source to have a common
--  implementation of Command_Line parsing across any version of GNAT.
...
package body CLIC.Command_Line is
